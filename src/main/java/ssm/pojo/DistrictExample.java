...
public class DistrictExample {
     ...
     * @author hewei
     */
    public DistrictExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @author hewei
     */
    public DistrictExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @author hewei
     */
    public DistrictExample page(Integer page, Integer pageSize) {

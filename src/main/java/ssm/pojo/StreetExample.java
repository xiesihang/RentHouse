...
public class StreetExample {
     ...
     * This field corresponds to the database table street
     *
     * @mbg.generated
     * @author hewei
     */
     ...
     * @author hewei
     */
    public StreetExample limit(Integer rows) {
        this.rows = rows;
        return this;
    }
     ...
     * @author hewei
     */
    public StreetExample limit(Integer offset, Integer rows) {
        this.offset = offset;
        this.rows = rows;
        return this;
    }
     ...
     * @author hewei
     */
    public StreetExample page(Integer page, Integer pageSize) {
